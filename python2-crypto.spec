%global commit0 7acba5f3a6ff10f1424c309d0d34d2b713233019
...
Source0:	https://github.com/dlitz/pycrypto/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Patch:		pycrypto-2.7-unbundle-libtomcrypt.patch
BuildRequires:	coreutils
BuildRequires:	findutils
BuildRequires:	gcc
BuildRequires:	gmp-devel >= 4.1
BuildRequires:	libtomcrypt-devel >= 1.16
BuildRequires:	python%{python2_pkgversion}
...
%prep
%autosetup -n pycrypto-%{commit0} -p1
...
%{python2_sitearch}/pycrypto-*-py2.*.egg-info

%changelog

* Tue Feb 19 2019 Unitedrpms Project <unitedrpms AT protonmail DOT com> 2.7-7
- Updated to 2.7
- Upstream
